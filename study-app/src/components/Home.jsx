    ...
    <div className="min-h-screen flex flex-row justify-between items-center lg:px-32 px-4 bg-[url('./assets/background.avif')] bg-cover bg-no-repeat ">
      <div className="md:w-2/4 text-center order-2 md:order-1 mt-5" style={{ marginTop: '-130px' }}>
        <div>
          ...
          <span className="text-brightGreen font-semibold text-5xl" style={{ color: '#539165' }}>StudyWeb</span>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded-full border-2 border-brightGreen mt-4">
            Get Start
          </button>
        </div>
      </div>
